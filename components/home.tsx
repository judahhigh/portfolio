    ...
    <div class="h-screen">
      ...
      <div class="grid grid-cols-6 gap-0">
        ...
        <div class="col-span-6 md:col-span-5 flex flex-col h-full justify-start items-center">
          <p class="text-6xl md:text-8xl font-extrabold py-8">Home</p>
          <p class="text-3xl md:text-4xl font-bold pb-8" id="introduction">
            Introduction
          </p>
          ...
          <div class="w-full flex flex-col pb-8 px-16" id="languages">
            <p class="text-3xl md:text-4xl font-bold pb-8 text-center">Languages</p>
          ...
          <div class="w-full flex flex-col pb-8 px-16" id="technologies">
            <p class="text-3xl md:text-4xl font-bold pb-8 text-center">Technologies</p>
            <ul class="grid lg:grid-cols-3 md:grid-cols-1 list-disc lg:justify-items-stretch justify-items-center gap-2">
          ...
          <div class="w-full flex flex-col pb-8 px-16" id="other">
            <p class="text-3xl md:text-4xl font-bold pb-8 text-center">Other</p>
            <ul class="grid lg:grid-cols-3 md:grid-cols-1 list-disc lg:justify-items-stretch justify-items-center gap-2">
              {profile.other.map((other) => (
                <li class="text-lg md:text-2xl">{other}</li>
              ))}
            </ul>
          </div>
          <div class="w-full flex flex-col pb-8 px-16" id="education">
            <p class="text-3xl md:text-4xl font-bold pb-8 text-center">Education</p>
            <ul class="flex flex-col list-none justify-items-center items-center gap-2">
              <li class="text-lg md:text-2xl text-center">
          ...
          <div class="w-full flex flex-col pb-8 px-16" id="publications">
            <p class="text-3xl md:text-4xl font-bold pb-8 text-center">Publications</p>
            <ul class="flex flex-col list-none justify-items-center items-center gap-2">
